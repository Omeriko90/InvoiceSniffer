import { endOfDay, startOfDay, startOfMonth, startOfQuarter, startOfYear, subDays, subMonths, subYears } from "date-fns"
...
export const DATE_RANGE_PRESETS = ["week", "month", "mtd", "qtd", "3m", "6m", "year", "ytd"] as const

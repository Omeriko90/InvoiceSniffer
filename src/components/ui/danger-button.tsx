...
export function DangerButton({
  ...
  return (
    <Button
      variant="outline"
      className={cn(
        "h-auto text-[13px] font-[600] text-danger bg-surface border-danger-border rounded-[9px] px-[14px] py-[7px] hover:bg-danger-bg hover:text-danger disabled:opacity-60",
        className
      )}
      {...props}
    />
